...
const PlaceOrder = () => {
    ...
    const { navigate, backendUrl, token, cartItems, setCartItems, getCartAmount, delivery_fee, products, addressList, getCartCount } = useContext(ShopContext);

    React.useEffect(() => {
        if (!isPlacingOrder && getCartCount() === 0) {
            navigate('/cart');
        }
    ...
    const onSelectSavedAddress = (e) => {
        ...
        setFormData({
            ...
            email: formData.email, // keep existing email if any
            ...
            switch (method) {
                ...
                case 'cod':
                    ...
                    if (response.data.success) {
                        ...
                        // Wait for the truck animation to reach the "Order Placed" state before clearing cart and navigating
                        setTimeout(() => {
                            setCartItems({})
                            navigate('/orders')
                        }, 11000)
            ...
            <div className='mt-8'>
                ...
                <div className='mt-12'>
                    ...
                    <div className='w-full text-end mt-8 flex justify-end'>
                        <OrderButton type='submit' text='PLACE ORDER' />
                    </div>
                </div>
            </div>
        </form>
